...
class PaypalPayment implements PaymentInterface
{
    ...
    public function process(float $totalOrder)
    {
        ...
        $redirectUrls->setReturnUrl(
            action('\Modules\ShoppingCart\Http\Controllers\ShoppingCartController@orderReturn')
        );
        $redirectUrls->setCancelUrl(
            action('\Modules\ShoppingCart\Http\Controllers\ShoppingCartController@orderCancel')
        );
