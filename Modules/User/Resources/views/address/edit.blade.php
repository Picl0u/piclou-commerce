...
@section('seoTitle')
    {{ __('user::user.edit_address') }} - {{ Setting('generals.seoTitle') }}
@endsection

@section('seoDescription')
    {{ __('user::user.edit_address') }} - {{ Setting('generals.seoDescription') }}
@endsection
...
@section('content')
    ...
    <div class="head-title">
        <div class="l-container">
            <h1>{{ __('user::user.edit_address') }}</h1>
        </div>
    </div>
        ...
        <div class="l-container">
            <div class="row gutters">
                ...
                <div class="col col-10">
                    ...
                    <div class="title">
                        <h2> {{ __('user::user.edit_address') }}</h2>
                    ...
                    {!! Form::open(['route' => ['user.addresses.update',$data->uuid]]) !!}
